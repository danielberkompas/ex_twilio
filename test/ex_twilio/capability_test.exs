defmodule ExTwilio.CapabilityTest do
  ...
  test ".with_account_sid sets the account_sid" do
    ...
    assert ExTwilio.Capability.with_account_sid(ExTwilio.Capability.new, "sid").account_sid == "sid"
  end

  test ".with_auth_token sets the auth_token" do

    assert ExTwilio.Capability.with_auth_token(ExTwilio.Capability.new, "token").auth_token == "token"
  end
