defmodule ExTwilio.WorkerCapabilityTest do
  ...
  test ".new sets the start time for the TTL to be the current time" do
    assert_in_delta ExTwilio.WorkerCapability.new("worker_sid", "workspace_sid").start_time, :erlang.system_time(:seconds), 1000
  end
  ...
  test ".new sets the workspace sid" do
    assert ExTwilio.WorkerCapability.new("worker_sid", "workspace_sid").workspace_sid == "workspace_sid"
  end
  ...
  test ".token sets 9 policies" do
    jwt = ExTwilio.WorkerCapability.new("worker_sid", "workspace_sid")
